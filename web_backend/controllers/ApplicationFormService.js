...
exports.addApplicationForm = function (req, res, next) { var args=req.swagger.params;
  /**
   * 新建申请表
   * 
   *
...
exports.deleteApplicationForm = function (req, res, next) { var args=req.swagger.params;
  /**
...
exports.findApplicationFormsByBank = function (req, res, next) { var args=req.swagger.params;
  /**
   * 根据开证行的编号获得信用证申请单
   *
   * bankNo String 开证行
...
exports.findApplicationFormsByCorp = function (req, res, next) { var args=req.swagger.params;
  /**
   * 根据企业号获得企业的申请单
   *
   * corpNo String 企业号
...
exports.findApplicationFormsByMyBank = function (req, res, next) { var args=req.swagger.params;
  /**
...
exports.findApplicationFormsByMyCorp = function (req, res, next) { var args=req.swagger.params;
/**
...
exports.getApplicationFormById = function (req, res, next) { var args=req.swagger.params;
/**
...
exports.getApplicationForms = function (req, res, next) { var args=req.swagger.params;
/**
...
exports.updateApplicationForm = function (req, res, next) { var args=req.swagger.params;
/**
...
exports.submitApplicationForm =function (req, res, next) { var args=req.swagger.params;
...
exports.confirmApplicationForm =function (req, res, next) { var args=req.swagger.params;
