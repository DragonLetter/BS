                        ...
                        <TabPane tab="开证申请书" key="1">
                            <div style={{ margin: '15px 5px', marginLeft: '20px' }}>
                                ...
                                <Row>
                                    ...
                                    <Col style={{ margin: '6px 0px', fontSize: '12px', color: '#32325d', height: '50px' }} span={21}><div>{chargeInIssueBank}<br />{chargeOutIssueBank}<br />{docDelay}<br />发起日期不能早于开证日期。</div></Col>
                                </Row>
                            </div>
